...
def view_demand(request):
     ...
     course_list = Course.objects.filter(courseCode__startswith = "EEE") | Course.objects.filter(courseCode__startswith = 'CoE')           # FOR DATABASE FUNCTIONALITY
     ...
     return render(request, 'demand2page.html', context)
